...
<script>
  ...
  export default {
    ...
    created: function () {
      this.obj.start_date = this.phasedata.start_period
      this.obj.end_date = this.phasedata.end_period 
    },
    methods: {
      submit: function () {
        this.onSubmit = true
        auth.putData2(this, '/programme/'+ this.programmeid +'/phase/'+ this.phasedata.id +'/update_period', this.obj)
                .then(res => {
                  console.log(res)
                  this.onSubmit = false
