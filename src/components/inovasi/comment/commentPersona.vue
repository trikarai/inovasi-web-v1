  ...
  export default {
    ...
    methods: {
      ...
      getComments: function () {
        auth.getData2(this, '/team_member/team/' + this.teamId + '/idea/' + this.ideaId + '/customer_segment/' + this.customersegmentId + '/persona/' + this.personaId + '/comment')
                .then(res=>{
                  if(res.status === 204){ 
                  }else{
                    return res.json()
      ...
      sendCommentTutor: function () {
        auth.postData2(this, '/tutor/'+ this.tutorId +'/team/' + this.$route.params.teamId + '/idea/' + this.$route.params.ideaId + '/customer_segment/' + this.$route.params.customersegmentId + '/persona/' + this.$route.params.personaId + '/comment', this.komentar)
                .then(res=>{
                  console.log(res)
                  this.komentar.content = ''
                  this.getComments()
      ...
      deleteComment: function (id) {
        auth.deleteData2(this, '/team_member/team/' + this.$route.params.teamId + '/idea/' + this.$route.params.ideaId + '/customer_segment/' + this.$route.params.customersegmentId + '/persona/' + this.$route.params.personaId + '/comment/' + id)
                .then(res=>{
                  console.log(res)
                  this.getComments()
                }, error=>{
      ...
      deleteCommentTutor: function (id) {
        auth.deleteData2(this, '/tutor/'+ this.tutorId +'/team/' + this.$route.params.teamId + '/idea/' + this.$route.params.ideaId + '/customer_segment/' + this.$route.params.customersegmentId + '/persona/' + this.$route.params.personaId + '/comment/' + id)
                .then(res=>{
                  console.log(res)
                  this.getComments()
                }, error=>{
      ...
      sendReplyTutor: function (id){
        auth.postData2(this, '/tutor/'+this.tutorId+'/team/' + this.$route.params.teamId + '/idea/' + this.$route.params.ideaId + '/customer_segment/' + this.$route.params.customersegmentId + '/persona/' + this.$route.params.personaId + '/comment/' + id, this.balasan)
                .then(res=>{
                  console.log(res)
                  this.closeReply()
                  this.getComments()
