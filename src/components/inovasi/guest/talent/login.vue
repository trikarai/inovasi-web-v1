...
<!--        <div class="alertlogin" v-if="error">
      ...
      <div class="contain"  v-bind:class="{ active: isActive }">
        ...
        <div class="card">
          ...
          <div>
            <h3 style="color: #797979;font-weight: 900;margin-bottom: 50px;margin-left: 57px;">MIKTI <span class="innovlbl">Start</span></h3>
          </div>
          <div>
...
<!--            <a href="http://dilo.id/login-dilo?view=reset"><i style="color:#96cc62" class="fa fa-key"></i> lupa your password?</a>-->
        ...
        <div class="card alt">
          ...
          <div class="button-contain">
              ...
              <button class="fpasswd"><router-link class="wpasswd" :to="'/reset-password'"><i class="fa fa-unlock"></i> Lupa Password</router-link> </button>
          </div>
