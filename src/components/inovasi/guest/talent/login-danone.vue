...
<!--        <div class="alertlogin" v-if="error">
      ...
      <div class="contain"  v-bind:class="{ active: isActive }">
        ...
        <div class="card">
          ...
          <div>
            <h3 style="color: #797979;font-weight: 900;margin-bottom: 50px;margin-left: 57px;">innov<span class="innovlbl">ID</span></h3>
          </div>
          <div>
          ...
          <div class="footer">
            ...
            <router-link to="/signup">
              <i style="color:#96cc62" class="fa fa-edit"></i> Sign Up
            </router-link> 
<!--            <span style="color:#848484;font-weight: 900;padding: 0px 10px;">|</span> -->
<!--            <a href="http://dilo.id/login-dilo?view=reset"><i style="color:#96cc62" class="fa fa-key"></i> Forgot your password?</a>-->
            </div>
        </div>
        <div class="card alt">
          ...
          <div class="button-contain">
              ...
              <button class="fpasswd"><router-link class="wpasswd" :to="'/reset-password'">Forgot Password</router-link> </button>
          </div>
