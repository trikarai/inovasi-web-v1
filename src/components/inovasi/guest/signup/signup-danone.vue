            ...
            <div class="row" style="margin-left:0px">
              <div style="display: -webkit-inline-box">
                  <input type="password" v-model="signup.password " required="required" autocomplete="off">
                    <label><i style="color:#96cc62" class="fa fa-key"></i> Password </label><div class=""  style="font-size: 18px;margin-top: 19px;"><a href="#" data-toggle="tooltip" data-placement="right" title="Password must alphanumeric and 8 character minimum"><i class="fa fa-info-circle"></i></a></div>
              </div>
...
<!--          <label style="line-height: 5px;"><i style="color:#96cc62" class="fa fa-globe"></i> Region</label>
        ...
        <div class="input-contain">
          ...
          <label><i style="color:#96cc62" class="fa fa-envelope"></i> Email</label><div class=""  style="font-size: 18px;margin-top: 19px;"><a href="#" data-toggle="tooltip" data-placement="right" title="insert valid email for verification"><i class="fa fa-info-circle"></i></a></div>
              </div>
              </div>
          <div class="bar"></div>
        </div>
...
//        sitekey: '6Ld47ZMUAAAAAM26YnKZuHXc6jfWKnM6xRW2eY4b',
        sitekey: '6LdIXJwUAAAAAFwBMxqhWCF6q8zbtRVBTIyReyVW',
        errors: [],
        err_msg: '',
        error: false,
        success: false,
