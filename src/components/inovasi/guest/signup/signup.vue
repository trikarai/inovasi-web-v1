    ...
    <ul>
      ...
      <div style="margin-top:65px" class="card">
        <error-flash
          ...
          v-bind:err_msg="err_msg"
        />

        <h1 class="title">Daftar</h1>
        <div class="input-contain dilomal">MIKTI - Start</div>
        <!--
        ...
        <div class="input-contain">
          ...
          <label>
            <i style="color:#96cc62" class="fa fa-user-circle"></i> Username
          </label>
          <div class="bar"></div>
        </div>
        ...
        <div class="input-contain">
          <div class="row" style="margin-left:0px">
            <div style="display: -webkit-inline-box">
              ...
              />
              <label>
                <i style="color:#96cc62" class="fa fa-key"></i> Password
              </label>
              <div class style="font-size: 18px;margin-top: 19px;">
                <a
                  href="#"
                  data-toggle="tooltip"
                  data-placement="right"
                  title="Password merupakan gabungan huruf dan angka dengan minimal 8 karakter"
                >
        ...
        <div class="input-contain">
          ...
          <label>
            <i style="color:#96cc62" class="fa fa-key"></i> Konfirmasi Password
          </label>
          <div class="bar"></div>
        </div>

        <div class="input-contain">
          <label style="line-height: 5px;">
            <i style="color:#96cc62" class="fa fa-globe"></i> Wilayah
          </label>
          <select
            style="margin-top: 30px;width: 100%;padding: 8px;border-color: #e0e0e0;"
        ...
        <div class="input-contain">
          ...
          <label>
            <i style="color:#96cc62" class="fa fa-user"></i> Nama
          </label>
          <div class="bar"></div>
        </div>
        ...
        <div class="input-contain">
          <div class="row" style="margin-left:0px">
            <div style="display: -webkit-inline-box">
              ...
              <label>
                <i style="color:#96cc62" class="fa fa-envelope"></i> Email
              </label>
              <div class style="font-size: 18px;margin-top: 19px;">
                <a
                  href="#"
                  data-toggle="tooltip"
                  data-placement="right"
                  title="Masukan email yang valid untuk verifikasi"
                >
                  <i class="fa fa-info-circle"></i>
                </a>
              </div>
        ...
        <div class="input-contain">
          ...
          <label>
            <i style="color:#96cc62" class="fa fa-phone"></i>Telepon (08xxx)
          </label>
          <div class="bar"></div>
        </div>
        <div class="input-contain">
          ...
          <label>
            <i style="color:#96cc62" class="fa fa-building"></i> Kota Asal
          </label>
          <div class="bar"></div>
        </div>

        <div class="input-contain">
          <label style="line-height: 0px;">
            <i style="color:#96cc62" class="fa fa-birthday-cake"></i> Tanggal Lahir
          </label>
          <input
            type="date"
        ...
        <div class="input-contain">
          <label style="line-height: 0px">
            <i style="color:#96cc62" class="fa fa-transgender"></i> Jenis Kelamin
          </label>

          <select
            style="margin: 0 0 0 0;margin-top: 35px;width: 100%;padding: 8px;border-color: #e0e0e0;"
            class="input-contain"
  ...
  methods: {
    ...
    submit: function() {
      if (this.signup.username === "") {
        ...
        this.signup.password.search(/[a-zA-Z]/) === -1 ||
        this.signup.password.search(/\d/) === -1
      ) {
        this.$notify({
          group: "passsignup",
          title: "Password",
        ...
        this.loading = true;
        auth.postData2(this, "/signup", this.signup).then(
          res => {
            console.log(res);
            this.loading = false;
          ...
          error => {
            ...
            this.$notify({
              group: "passsignup",
              title: "ERROR",
              text: error.body.meta.error_details[0],
              type: "error"
            });
          }
        );
    ...
    checkForm(e) {
      ...
      if (!this.signup.city_of_origin)
        this.errors.push("City of Origin required.");
      ...
      if (!this.signup.password) {
        ...
        this.errors.push(
          "Password must be 8 digit password with at least 1 alphabet and 1 number"
        );
      } else if (this.signup.password !== this.signup.cpassword) {
        ...
        this.errors.push(
          "Password must be with at least 1 alphabet and 1 number"
        );
      }
