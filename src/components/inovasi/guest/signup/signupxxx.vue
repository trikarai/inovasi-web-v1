...
-->
    ...
    <div style="margin-top:65px" class="card">
        ...
        <div class="input-contain dilomal">BEKUP 2018</div>
...
<!--            <label style="line-height: 5px;"><i style="color:#96cc62" class="fa fa-globe"></i> Region</label>
        ...
        <div class="input-contain">
          ...
          <label><i style="color:#96cc62" class="fa fa-phone"></i> Phone</label>
          <div class="bar"></div>
        </div>
        <div class="input-contain">
...
<!--           <vue-recaptcha
          ...
          <!--<button @click="test"><span>Test Routing</span></button>--> 
        </div>
    </div>    
