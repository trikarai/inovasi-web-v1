<template>
  <div>
    ...
    <form-admin v-bind:edit="edit" v-bind:adminId="adminId" v-if="showForm" @close="showForm = false" @closeModalRefresh="closeModalRefresh()">
    </form-admin>
...
<script>
  ...
  export default {
    ...
    methods: {
      getData: function () {
        auth.getData(this, '/administrator')
      },
      ...
      deleteAdmin: function (id) {
        auth.deleteData(this, '/administrator/' + id)
      },
