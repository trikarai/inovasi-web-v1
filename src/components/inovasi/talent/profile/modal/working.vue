      ...
      <div class="modal-wrapper">
        <div class="modal-container">
          ...
          <div class="modal-body">
            <div class="ui form">                
              <div class="field">  
                  <h2 v-if="edit">Edit Work Experience</h2>
                  <h2 v-if="!edit">Add Work Experience</h2>
                  <div class="garis"></div>
                <div>                      
                  <form>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <input class="kotak" type="text" v-model="obj.company_name" maxlength="35">
                      </div>
                    </div>
                    <div class="row">  
                      <div class="col-md-4">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <input class="kotak" type="text" v-model="obj.role" maxlength="35">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-4">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      submit: function () {
        this.onSubmit = true
        auth.postData2(this, '/talent/working_experience', this.obj)
                .then(response => {
      ...
      update: function () {
        this.onSubmit = true
        auth.putData2(this, '/talent/working_experience/' + this.objId, this.obj)
                .then(response => {
                  console.log(response)
          this.onSubmit = false
                  this.$emit('closeModalRefresh')
