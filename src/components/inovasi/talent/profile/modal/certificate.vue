      ...
      <div class="modal-wrapper">
        <div class="modal-container">
          ...
          <div class="modal-body">
            <div class="ui form">                
              <div class="field">  
                  <h2 v-if="edit">Edit Certificate</h2>
                  <h2 v-if="!edit">Add Certificate</h2>
                  <div class="garis"></div>
                <div>                      
                  <form>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <label style="padding: 6px">Issued Date</label>
                      </div>
                      <div class="col-md-6">
                        <input class="kotak" type="date" v-model="obj.issued_date" maxlength="35">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-4">
                        <label style="padding: 6px">valid Until</label>
                      </div>
                      <div class="col-md-6">
                        <input class="kotak" type="date" v-model="obj.valid_until" maxlength="35">
                      </div>
                    </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      submit: function () {
        this.onSubmit = true
        auth.postData2(this, '/talent/skill/' + this.skillId + '/certificate', this.obj)
                .then(response => {
      ...
      update: function () {
        this.onSubmit = true
        auth.putData2(this, '/talent/skill/' + this.skillId + '/certificate/' + this.objId, this.obj)
                .then(response => {
                  console.log(response)
          this.onSubmit = false
                  this.$emit('closeModalRefresh')
