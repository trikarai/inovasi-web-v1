                  ...
                  <tr v-for="data in data.list">
                    ...
                    <td>
                      <template v-if="role === 'Talent'">
                        ...
                        <!-- <router-link style="margin-top:5px;" class="btn btn-default btn-sm" v-bind:to="'/team/'+ teamId + '/idea/'+ ideaId + '/cs/' + customersegmentId + '/persona/' + personaId + '/vp/' + data.id + '/experiment'"><i class="fa fa-thermometer-2"></i> Rencana Pengembangan</router-link> -->
                        <!-- <router-link style="margin-top:5px;" class="btn btn-default btn-sm" v-bind:to="'/team/'+ teamId + '/idea/'+ ideaId + '/cs/' + customersegmentId + '/persona/' + personaId + '/vp/' + data.id + '/experiment'"><i class="fa fa-thermometer-2"></i> Data Bisnis</router-link> -->
                      </template>  
                      <template v-else>
