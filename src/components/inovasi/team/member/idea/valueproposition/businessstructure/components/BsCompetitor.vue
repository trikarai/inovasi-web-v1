<template>
  <div>
      ...
      <div class="row">
        <div v-if="data.total != 0" class="col-md-5" style="margin-top:0px;">
          <div class="list-group-item" style="text-align: center;border-radius: 0px;">
            <a data-toggle="collapse" href="#collapsekomp">
              <b>Pelajari Materi Competitor</b>
            </a>
          </div>
          <div class>
            <div id="collapsekomp" class="panel-collapse collapse">
              <div class="panel-body">
                <iframe
                  src="https://docs.google.com/presentation/d/e/2PACX-1vTRnH5vYkIY8bmiH_Ru4x9rYWTybMHt753wA_oilipY-Sigbv39ijX71eaRSFlqMVAgb6swgAX0q6I6/embed?start=false&loop=false&delayms=3000"
                  frameborder="0"
                  width="100%"
                  height="315"
      ...
      <tbody>
        <tr v-for="data in data.list">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td v-for="data in data.list">
                  <span v-html="data.value_proposed"></span>
                </td>
              </tr>
              <tr>
                <th class="header mscolor">Comparative Advantage</th>
                <td v-for="data in data.list">
                  <span v-html="data.comparative_advantage"></span>
                </td>
              </tr>
              <tr>
                <th class="header mscolor">Differential Advantage</th>
                <td v-for="data in data.list">
                  <span v-html="data.differential_advantage"></span>
                </td>
              </tr>
              <tr>
                <th class="header mscolor">Focus</th>
                <td v-for="data in data.list">
                  <span v-html="data.focus"></span>
                </td>
              </tr>
              <tr>
                <th class="header mscolor">Asset</th>
                <td v-for="data in data.list">
                  <span v-html="data.asset"></span>
                </td>
              </tr>
              <tr>
                <th class="header mscolor">Unfair Advantage</th>
                <td v-for="data in data.list">
                  <span v-html="data.unfair_advantage"></span>
                </td>
              </tr>
          ...
          <div style="padding:10px;margin-top:30px;" v-else>
            <div class="col-md-5">
              <iframe
                src="https://docs.google.com/presentation/d/e/2PACX-1vRGGEzMHad24qkb3KZ6xOu4v2JzxC5qIy5f1u_DX4MpdJ40M9LFaK8AkLEXP6DfG6b5SVTFeXpSAXpu/embed?start=false&loop=false&delayms=3000"
                frameborder="0"
                width="100%"
                height="329"
                allowfullscreen="true"
    ...
    <a v-if="role === 'Talent'" class="btn btn-default" @click="showFormCompetitor()">
      <span class="glyphicon glyphicon-plus-sign"></span> Tambah Data Bisnis Anda Dahulu
    </a>
    </template>
    <template v-else>
    <a v-if="role === 'Talent'" class="btn btn-default" @click="showFormCompetitor()">
